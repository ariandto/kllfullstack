...
const CompanyProfile = () => {
    ...
    const fetchPivotData = async (facilityName: string): Promise<void> => {
        ...
        try {
            const res = await fetch(`${API_URL}/transport/scm-profile/armada?facility=${encodeURIComponent(facilityName)}`, { credentials: "include" });
            const data = await res.json();
            setPivotData({
                ...
                {loadingPivot && (
                    <div className="card shadow-lg border-0 rounded-4" style={{ background: "rgba(255, 255, 255, 0.95)" }}>
                        <div className="card-body text-center py-5">
                            ...
                            <p className="text-primary fw-semibold fs-5 mb-0">Loading facility ...</p>
                        </div>
                    </div>
                )}
                        ...
                        <div className="card shadow-lg border-0 rounded-4 overflow-hidden">
                            {imgUrl && (
                                <div className="position-relative" style={{ height: "450px" }}>
                                    <img src={imgUrl} alt="Facility" className="w-100 h-100" style={{ objectFit: "cover" }} />
                                    <div
                            ...
                            <div
                                ...
                                style={{
                                    background: "linear-gradient(135deg, #667eea 0%, #0c5fdbff 100%)",
                                }}
                            >
                            ...
                            <div className="col-12 col-md-6 col-xl-3">
                                <div className="card shadow-lg border-0 rounded-4 h-100 overflow-hidden">
                                    <div
                                        ...
                                        style={{
                                            background: "linear-gradient(135deg, #1e3fd4ff 0%, #33b2e4ff 100%)",
                                        }}
                                    >
                                        <div className="d-flex justify-content-between align-items-start mb-3">
                                            <div className="text-white">
                                                ...
                                                <h1
                                                    className={`display-4 fw-bold mb-0 ${getUtilizationColor(utilizationRate)}`}
                                                    style={{
                                                        color: "white",
                                                        fontSize: "5rem",
                                                    }}
...
<div className={`mt-1 small ${conditionColor}`}>
    {condition}
                                    ...
                                    >
                                        <div className="d-flex justify-content-between align-items-start mb-3">
                                            <div className="text-white">
                                                ...
                                                <h1 className="display-4 fw-bold mb-0" style={{ fontSize: "5rem" }}>
                                                    {(() => {
                                                        if (!pivotData.armada || pivotData.armada.length === 0) return 0;
                                                        const row = pivotData.armada[0];
                                                        const armadaKeys = Object.keys(row).filter((key) => key.toLowerCase() !== "relasi");
                            ...
                            <div className="col-12 col-md-6 col-xl-3">
                                <div className="card shadow-lg border-0 rounded-4 h-100 overflow-hidden">
                                    <div
                                        className="card-body p-4"
                                        style={{
                                            background: "linear-gradient(135deg, #fb9393ff 0%, #f5576c 100%)",
                                        }}
                                    >
                                        <div className="d-flex justify-content-between align-items-start mb-3">
                                            <div className="text-white">
                                ...
                                <div className="card shadow-lg border-0 rounded-4 h-100">
                                    <div className="card-body p-4">
                                        <div className="d-flex justify-content-between align-items-center mb-4">
                                            ...
                                            <span className="badge bg-primary bg-opacity-10 text-primary px-3 py-2">DO Metrics</span>
                                        </div>
                            ...
                            <div className="col-12 col-lg-4">
                                <div className="card shadow-lg border-0 rounded-4 h-100">
                                    <div className="card-body p-4">
                                        ...
                                        {/* Summary + Donut */}
                                        {(() => {
                                            if (jalurData.length === 0) return <p className="text-muted">No jalur data available</p>;
                                                        ...
                                                        <div className="card border-0 shadow-sm rounded-4">
                                                            <div className="card-body">
                                                                ...
                                                                <ResponsiveContainer width="100%" height={250}>
                                                                    <PieChart>
                                                                        <Pie data={donutData} cx="50%" cy="50%" innerRadius={60} outerRadius={85} dataKey="value" label={({ name, value }) => `${name} (${value})`}>
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            <div className="vstack gap-2">
                                                                                                {grouped[area].map((jalur, i) => (
                                                                                                    <div key={i} className="d-flex justify-content-between align-items-center p-2 bg-white rounded shadow-sm">
                                                                                                        <span>{jalur}</span>
                                                                                                        <span className="badge bg-primary bg-opacity-10 text-primary px-3 py-1">Jalur</span>
                                                                                                    </div>
                                                                                                ))}
                                                                                            </div>
                                                                                        </div>
                                ...
                                <div className="card shadow-lg border-0 rounded-4 h-100">
                                    <div className="card-body p-4">
                                        <div className="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <span className="badge bg-success bg-opacity-10 text-success px-3 py-2">Armada</span>
                                        </div>
                                        ...
                                        {(() => {
                                            ...
                                            const row = pivotData.armada[0];
                                            const keys = Object.keys(row).filter((key) => key.toLowerCase() !== "relasi" && parseFloat(row[key]) > 0);
                                ...
                                <div className="card shadow-lg border-0 rounded-4 h-100">
                                    <div className="card-body p-4">
                                        ...
                                        <div className="vstack gap-3">
                                            ...
                                            <div className="p-3 bg-light rounded-3">
                                                <p className="text-muted small mb-2">Loading Dock</p>
                                                <p className="fw-bold text-dark mb-0 fs-5">{pivotData.Is_Loading_Dock}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            style={{
                                background: "linear-gradient(135deg, #12b2b8ff 0%, #42daf5ff 100%)",
                            }}
                        >
                            <div className="card-body p-4">
                                    ...
                                    <div className="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <div className="vstack gap-2 small text-dark ">
                                            <div className="d-flex align-items-center gap-2 ">
                                                <Truck size={26} />
                                                <span>
                                                    Loading Dock: <strong>{pivotData.Is_Loading_Dock}</strong>
                                                </span>
                                            </div>
                                            <div className="d-flex align-items-center gap-2">
                                                <Building2 size={26} />
                                                <span>
                                                    Type: <strong>{pivotData.TYPE}</strong>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
