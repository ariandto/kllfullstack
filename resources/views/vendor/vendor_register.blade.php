            ...
            <div class="row">
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="card-body ">
                        ...
                        <form class="needs-validation mt-4 pt-2" action="{{ route('vendor.register_submit') }}"
                            method="post">
                            @csrf
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <input type="userid" name='userid' class="form-control" id="userid"
                                                placeholder="Enter User ID" required autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group auth-pass-inputgroup">
                                                ...
                                                <button class="btn btn-light shadow-none ms-0 toggle-password"
                                                    type="button" data-target="password" id="password-addon">
