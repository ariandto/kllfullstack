        ...
        <div class="d-flex">
                        ...
                        @if (session('facility_info'))
                            @foreach (session('facility_info') as $facility)
                                <div class="dropdown-item d-flex flex-column">
                                    <a class="dropdown-item"><i class="bx bx-box"></i>
                                        {{ $facility['Facility_ID'] }}</a>
                                    <a class="dropdown-item"><i class="bx bx-box"></i> {{ $facility['Relasi'] }}</a>
                                    <a class="dropdown-item"><i class="bx bx-building-house"></i>
                                        {{ $facility['Name'] }}</a>
                                </div>
                            @endforeach
                        @else
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('vendor.change.password') }}"><i
