...
use App\Models\Admin\ApplicationRequest\ModelReAssignAR;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Auth;


class ReAssignAR extends Controller
{

    public function ViewPageReAssignAR(Request $request)
    {
        try {
            ...
            $getKLIP = ModelReAssignAR::getKLIP($UserID, $Key1, $Key2, $Key3);


            //End Section Menampilkan Site Detail
            // Kirim data ke view
            return view(
                'admin.applicationrequest.reassign_ar',
                compact('getKLIP')
            );
        } catch (\Exception $e) {
    ...
    public function ViewPageSubmitReAssignAR(Request $request)
    {
        return view('admin.applicationrequest.reassign_ar');
    }
}
