...
use App\Models\Admin\ApplicationRequest\ModelAssignAR;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Auth;


class AssignAR extends Controller
{

    public function ViewPageAssignAR(Request $request)
    {
        try {
            ...
            $getKLIP = ModelAssignAR::getKLIP($UserID, $Key1, $Key2, $Key3);


            //End Section Menampilkan Site Detail
            // Kirim data ke view
            return view(
                'admin.applicationrequest.assign_ar',
                compact('getKLIP')
            );
        } catch (\Exception $e) {
