...
namespace App\Models\Admin\Transaction\Storing;
...
class ModelCreatePicklistBalikan extends Model
{
    public static function getstockeData1($type, $sku, $whseid, $relasi, $loc, $storerkey, $lpn, $param1, $param2, $param3)
    {
        try {
    ...
    public static function getstockeData2($type, $sku, $whseid, $relasi, $loc, $storerkey, $lpn, $param1, $param2, $param3)
    {
        try {
            //dd($type, $sku, $whseid, $relasi, $loc, $storerkey, $lpn, $param1, $param2, $param3);
            set_time_limit(300);
            ...
            $results = [];
            $results[] = $stmt->fetchAll(\PDO::FETCH_ASSOC); // Ambil hasil query
            $headers2 = array_keys($results[0][0] ?? []);
